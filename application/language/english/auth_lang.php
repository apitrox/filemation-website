...
// Errors
$lang['auth_incorrect_password'] = '<br>You have entered an incorrect password';
$lang['auth_incorrect_login'] = '<br>You have entered invalid login data';
$lang['auth_dupe_user'] = '<br>User is logged in from another location';
...
$lang['auth_incorrect_captcha'] = 'Your confirmation code does not match the <br> one that was provided. Please try again.';
...
$lang['auth_message_kicked'] = 'Your account is logged in from another location. You have been logged out.<br><a href="auth">Back to login page</a>';
